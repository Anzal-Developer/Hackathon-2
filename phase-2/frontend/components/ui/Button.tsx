...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      primary:
        'bg-gradient-to-r from-emerald-500 to-teal-500 text-white hover:from-emerald-600 hover:to-teal-600 focus-visible:ring-emerald-500 shadow-md hover:shadow-lg active:scale-[0.98]',
      secondary:
        'bg-teal-500 text-white hover:bg-teal-600 focus-visible:ring-teal-500 shadow-md hover:shadow-lg active:scale-[0.98]',
      outline:
        'border-2 border-gray-300 text-gray-700 hover:border-emerald-500 hover:text-emerald-600 focus-visible:ring-emerald-500 active:scale-[0.98]',
      ghost:
