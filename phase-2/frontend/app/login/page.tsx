...
import { Mail, Lock, Eye, EyeOff, ListTodo } from 'lucide-react';
        ...
        >
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Sign in to your NestTask account
            </p>
          </div>
          ...
          <div className="text-center text-white">
            ...
            >
              ...
              <p className="text-white/80 max-w-sm">
                Organize your tasks, track progress, and accomplish more every day with NestTask.
              </p>
            </motion.div>
          </div>
        </div>
