  ...
  return (
    <div className="min-h-screen flex flex-col">
          ...
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-2">
              <Link
                href="#features"
                className={cn(
                  'text-sm font-medium hidden sm:block px-3 py-1.5 rounded-lg transition-colors',
                  isScrolled
      ...
      <section className="relative overflow-hidden">
        {/* Background Gradient */}
        <div className="absolute inset-0 bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-400" />
        ...
        <Container size="xl" padding="lg">
          <div className="relative pt-28 pb-20 md:pt-44 md:pb-32 lg:pt-48 lg:pb-40">
            <motion.div
              initial="initial"
              animate="animate"
            ...
            >
              ...
              >
                <Link href="/signup">
                  <Button
                    size="lg"
                    className="bg-white text-emerald-600 hover:bg-gray-100 shadow-xl hover:shadow-2xl"
      ...
      <section className="py-20 md:py-32">
        <Container size="lg" padding="lg">
          <motion.div
            ...
            className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-400 p-8 md:p-16 text-center"
          >
            {/* Background Patterns */}
            ...
            <div className="relative">
              ...
              <p className="text-lg text-white/90 max-w-xl mx-auto mb-8">
                Join thousands of productive people who use NestTask to manage
