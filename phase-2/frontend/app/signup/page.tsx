...
import { Mail, Lock, Eye, EyeOff, User, ListTodo } from 'lucide-react';
          ...
          <div className="text-center text-white">
            ...
            >
              ...
              <p className="text-white/80 max-w-sm">
                Create an account and start building productive habits with your personal task manager.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        ...
        >
          ...
          <Link href="/" className="flex items-center gap-2 mb-8">
            ...
            <span className="text-xl font-bold text-gray-900">NestTask</span>
          </Link>
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Get started with NestTask for free
            </p>
          </div>
